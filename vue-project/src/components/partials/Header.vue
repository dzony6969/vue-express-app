...
<div>
    ...
    >
      <v-list dense>
        ...
        <v-list-tile 
        active-class="success elevation-10 ma-2"
        to='/'>
          <v-list-tile-action>
            <v-icon>home</v-icon>
          </v-list-tile-action>
        ...
        <v-list-tile 
        active-class="success elevation-10 ma-2"
        v-if='admin.isAdmin' to='/dashboard'>
          <v-list-tile-action>
        ...
        <v-list-tile
        active-class="success elevation-10 ma-2"
         v-if='admin.isAdmin' to='/adminpost'>
          <v-list-tile-action>
